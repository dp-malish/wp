...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			...
			<em>Ваш комментарий находится на модерации.</em>
			<?php endif; ?>
			<br />

			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('j F Y') ?> в <?php comment_time() ?></a> <?php edit_comment_link('редактировать','&nbsp;&nbsp;',''); ?></small>
...
<p>Вы вошли как <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?action=logout" title="Выйти из аккаунта">Выйти &raquo;</a></p>
...
<p style="text-align: right;"><input name="submit" type="submit" id="submit" tabindex="5" value="Оставить комментарий!" />
