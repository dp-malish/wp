...
$options = array (
                array(  "name" => "Header Ad 234x60",
                        "desc" => "This is for the 234x60 Google AdSense banner in the header.<br /><br />",
                        "id" => "spp_banner",
                        "std" => "(Input html or adsense code here)",
                        "type" => "textarea"),
		array(  "name" => "Sidebar Ad 250x250",
                        "desc" => "This is for the 250x250 Google AdSense banner in the sidebar.<br /><br />",
                        "id" => "spp_adsense_250",
                        "std" => "(Input html or adsense code here)",
                        "type" => "textarea"),
                array(  "name" => "Footer",
...
function art_add_admin() {
    ...
    add_theme_page("Computer Support Options", "Computer Support Options", 'edit_themes', basename(__FILE__), 'art_admin');
...
?>
<div class="wrap">
	<h2>Computer Support Options</h2>
